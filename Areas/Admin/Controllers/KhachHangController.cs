...
namespace WebNC.Areas.Admin.Controllers
{
    public class KhachHangController : BaseController
    {
        ...
        {
            var khach = db.KhachHangs.Where(x => x.TenKhach.Contains(ten)).ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KhachID,TenKhach,SDT,DiaChi,Email,Username,Password")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
